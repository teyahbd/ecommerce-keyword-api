...
Through this, the API essentially recommends similar words based on the submitted words. The list of positive words contribute positively to the similarity, and the list of negative words contribute negatively. More details the function used for these word vector calculations can be found [here](https://radimrehurek.com/gensim/models/keyedvectors.html).
